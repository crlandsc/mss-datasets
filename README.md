...
- **MedleyDB v1+v2**: 196 tracks, ~121 instrument labels mapped to stems. 5 tracks are excluded (stem bleed) and 38 individual stems across 26 tracks are excluded (audio content doesn't match routed category). See [MedleyDB Exclusions](docs/medleydb_exclusions.md) for details.
